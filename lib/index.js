...
module.exports = function (app) {
    app.on(['pull_request.opened', 'pull_request.reopened', 'pull_request.labeled'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        var config, pr, prLabels, labelsToAdd, prHasAppliedLabels, prUser, ownerSatisfied, missingRequiredLabels, prParams;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, context.github.issues.addLabels(context.issue({ labels: labelsToAdd }))];
                case 3:
                    // trying to apply existing labels to PR. If labels ddn't exist, this call will fail
                    _a.sent();
                    _a.label = 4;
