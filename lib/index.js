...
module.exports = function (app) {
    app.on(['pull_request.opened', 'pull_request.reopened', 'pull_request.labeled', 'pull_request.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        var config, pr, prLabels, labelsToAdd, prHasAppliedLabels, prUser, ownerSatisfied, missingRequiredLabels, prParams, labels;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(missingRequiredLabels.length === 0 && ownerSatisfied)) return [3 /*break*/, 5];
