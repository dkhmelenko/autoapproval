...
module.exports = function (app) {
    app.on(['pull_request.opened', 'pull_request.reopened'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        var config, pr, prUser, ownerSatisfied, prLabels, missingRequiredLabels, prParams, labelsToAdd;
